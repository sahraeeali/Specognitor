...
llvm::Type *KFunction::getReturnType() { return function->getReturnType(); }

unsigned KFunction::getAssemblyLine() { // should be done using kInstIterator
  KInstIterator pc = instructions;
  return pc->info->assemblyLine;
}

std::string KFunction::getFunctionName() {
